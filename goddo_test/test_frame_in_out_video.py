...
def assert_after_in_out(app_thread, windows_container, video_path, cur_frame_no):
    # asserts
    ...
    assert windows_container.preview_window.preview_widget.get_cur_frame_no() == cur_frame_no
    ...
    assert app_thread.mon.state.preview_window.frame_in_out == FrameInOut(cur_frame_no)
    assert app_thread.mon.state.preview_window.current_frame_no == cur_frame_no
    ...
    assert state_dict['frame_in_out']['in_frame'] == cur_frame_no
    assert state_dict['frame_in_out']['out_frame'] is None
    assert state_dict['current_frame_no'] == cur_frame_no
