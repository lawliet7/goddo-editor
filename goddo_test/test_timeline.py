...
from goddo_test.utils.test_utils import click_on_prev_wind_slider, drag_and_drop, drop_video_on_preview, get_current_method_name, get_img_asset, get_test_vid_path, grab_screenshot, save_reload_and_assert_state, wait_until, pil_img_to_arr, cmp_image
...
def test_drop_clip_in_only_hover(app_thread, windows_container: WindowsContainer, blank_state):
    ...
    hover_over_rect_and_assert(timeline_window)
